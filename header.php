...
<html class="no-js">
  <head>
	...
	<style type="text/css">@media (min-width:768px){#kratos-widget-area,.kratos-start,.kratos-hentry,.post-navigation,.comment-list,.comments-nav{filter:alpha(Opacity=90);-moz-opacity:0.9;opacity:0.9}.comment-respond{background-color:RGB(255,255,255,0.85)}}</style>
	<?php endif; ?>
  </head>
	<?php flush(); ?>
