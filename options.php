...
function optionsframework_options(){
    ...
    $options[] = array(
        ...
        'id'=>'fa_url',
        'std'=>'https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css',
        'type'=>'text');
    $options[] = array(
        'name'=>'自定义Bootstrap(JS)',
        'desc'=>'自定义Bootstrap链接，留空将从本地加载',
        'id'=>'bs_url',
        'std'=>'https://apps.bdimg.com/libs/bootstrap/3.3.4/js/bootstrap.min.js',
        'type'=>'text');
    $options[] = array(
        'name'=>'自定义jQuery',
        'desc'=>'自定义jQuery链接，留空将从本地加载',
        'id'=>'jq_url',
        'std'=>'https://libs.baidu.com/jquery/2.1.4/jquery.min.js',
        'type'=>'text');
    $options[] = array(
        'name'=>'特色图片(仅针对新式布局)',
    ...
    $options[] = array(
        'name'=>'前端压缩',
        'desc'=>'是否启用HTML压缩功能(如遇显示错乱请关闭此功能)',
        'id'=>'site_comp',
        'std'=>'0',
        'type'=>'checkbox');
    $options[] = array(
    ...
    $options[] = array(
        ...
        'desc'=>'例如以//fczbl.vip代替https://fczbl.vip，一般不建议',
        'id'=>'html_scheme',
        'std'=>'0',
        'type'=>'checkbox');
    $options[] = array(
