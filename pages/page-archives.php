            ...
            <?php if(have_posts()){the_post(); ?>
                <article>
                    <div class="kratos-hentry kratos-post-inner clearfix">
                        ...
                        <p style="text-align:center"><span style="color:#999">当前共有<?php echo wp_count_posts()->publish; ?>篇公开文章，<?php echo wp_count_posts('page')->publish; ?>个公开页面。点击月份可展开文章~<a id="al_collapse" style="color:#999;display:none">[折叠全部]</a><a id="al_expand" style="color:#999">[展开全部]</a></span></p>
                        <hr/>
                        <h4>Tags</h4>
                        <div class="arc-tag">
                        <?php echo $arc_tags; ?>
                        ...
                        <footer class="kratos-entry-footer clearfix">
                                ...
                                <?php if(kratos_option('page_like_donate')) echo '<a href="javascript:;" class="Donate"><i class="fa fa-bitcoin"></i> 打赏</a>';
                        ...
                        <div class="kratos-hentry kratos-copyright text-center clearfix">
                            ...
                            <h5>本站文章采用 <a rel="license nofollow" target="_blank" href="http://creativecommons.org/licenses/by-sa/4.0/">知识共享署名-相同方式共享 4.0 国际许可协议</a> 进行许可</h5>
                        </div>
